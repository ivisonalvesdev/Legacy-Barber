...
//
// NOTA: NÃO usar a opção `accessToken` aqui — ela desabilita getSession() e
// onAuthStateChange (o app inteiro depende deles para o login). O token do
// Realtime é tratado no próprio effect do canal (App.tsx), com setAuth.
